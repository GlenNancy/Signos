    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun signos() {
            if ((dia >= 21 && mes_numero == 3) || (dia <= 20 && mes_numero == 4)) {                      // Áries: 21 de março a 20 de abril
                ...
                val toast = Toast.makeText(this, "Seu signo é Escorpião!", Toast.LENGTH_SHORT).show()
                ...
                val toast = Toast.makeText(this, "Seu signo é Sagitário!", Toast.LENGTH_SHORT).show()
                ...
                val toast = Toast.makeText(this, "Seu signo é Capricórnio!", Toast.LENGTH_SHORT).show()
